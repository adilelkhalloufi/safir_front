...
import { CheckCircle2, Clock, ChevronRight, Sparkles, Scissors, Droplets } from 'lucide-react'
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2 text-xs">
                                        ...
                                        <span className="text-green-600 font-medium">{svc.duration_minutes} min</span>
                                    </div>
