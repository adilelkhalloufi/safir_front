      ...
      <div className='flex items-center gap-4'>
        ...
        <Select value={statusFilter} onValueChange={handleStatusFilter}>
          <SelectTrigger className='w-[180px]'>
            <SelectValue placeholder={t('subscriptions.filterByStatus', 'Filter by status')} />
          </SelectTrigger>
          <SelectContent>
            ...
            <SelectItem value='suspended'>{t('subscriptions.suspended')}</SelectItem>
          </SelectContent>
        </Select>
      </div>
              ...
              {table.getRowModel().rows?.length ? (
                ...
                <TableRow>
                  <TableCell colSpan={columns.length} className='h-24 text-center'>
                    <EmptyStateComponent
                      icon='database'
                      title={t('subscriptions.noSubscriptions', 'No subscriptions found')}
                      description={t('subscriptions.noSubscriptionsDesc', 'No subscriptions match your criteria')}
                    />
                  </TableCell>
                </TableRow>
              )}
