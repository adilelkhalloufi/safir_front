...
import { decodeUrlId, setPageTitle, handleErrorResponse } from '@/utils';
...
export default function EditStaff() {
  ...
  const staffFields: MagicFormGroupProps[] = [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: t('staff.maxConcurrentBookings', 'Max Concurrent Bookings'),
          type: 'number',
          defaultValue: 2,
          placeholder: '2',
        },
        {
          name: 'priority',
          label: t('staff.priority', 'Priority'),
          type: 'number',
          defaultValue: 5,
          placeholder: '5',
        },
  ...
  const initialValues = useMemo(() => {
    ...
    return {
      ...
      max_concurrent_bookings: staff?.max_concurrent_bookings || 2,
