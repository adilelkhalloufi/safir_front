...
export default function TypeServicesEdit() {
    ...
    const handleSubmit = (values: any) => {
        setLoading(true);
        http
            .put(apiRoutes.adminTypeResourceById(parseInt(id!)), values)
            .then(() => {
                toast({
                    title: t('common.success', 'Success'),
                    description: t('typeServices.updateSuccess', 'Service type updated successfully'),
                });
                navigate(webRoutes.typeResources.view.replace(':id', id!));
            })
            .catch((e) => {
    ...
    const serviceTypeFields: MagicFormGroupProps[] = [
        {
            ...
            fields: [
                ...
                {
                    name: 'description_fr',
                    label: t('typeServices.descriptionFr', 'Description (French)'),
                    type: 'textarea',
                    placeholder: t('typeServices.descriptionPlaceholderFr', 'Description en français'),
                },
                {
                    name: 'description_en',
                    label: t('typeServices.descriptionEn', 'Description (English)'),
                    type: 'textarea',
                    placeholder: t('typeServices.descriptionPlaceholder', 'Description in English'),
                },
                {
                    name: 'icon',
