...
const Login = () => {
    ...
    defaultHttp
      ...
      .then((response) => {
        ...
        const admin: Admin = {
          ...
          user: response.data.authorisation.user
        };
  ...
  return (
    <Fragment>
      <h1 className="text-xl flex items-center gap-4 font-bold leading-tight tracking-tight text-gray-900 md:text-2xl text-left text-opacity-30 tracking-wide">
